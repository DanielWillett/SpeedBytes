...
/// </summary>
[Flags]
public enum ByteStringFormat : long
{
    /// <summary>
    /// Do not log anything. Doesn't affect the behavior of <see cref="ByteFormatter.FormatBinary(ReadOnlySpan{byte},ByteStringFormat)"/>
    /// </summary>
    NoLogging,
